    ...
    return(
        <div>
                <div className="headline">
                    <p>Hate Crime Is Feared in Shooting of 2 Indians in Kansas</p>
                </div>
                ...
                <div className="headline">
                    <p>Uber Lawsuit Puts Spotlight on Rush for Driverless Cars</p>
                </div>
                <div className="content-holder">  
                    <div className="content">
                        <p>
                ...
                <div className="content-holder">  
                    ...
                    <div className="content-img">
                        <img src={`${process.env.PUBLIC_URL}/imgs/image5.png`} />
                    </div>
                </div>
